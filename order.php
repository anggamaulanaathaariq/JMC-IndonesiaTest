    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-center">
        <div class="col-md-7">
          <div class="row mb-5">
            <div class="col-12 ">
              <h2 class="site-section-heading text-center">Beli paket pembelajaran PHP</h2>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-lg-8 mb-5">
              ...
              <div class="row form-group">
                  ...
                  <div class="col-md-12">
                    <label class="text-black" for="nama">Name</label> 
                ...
                <div class="row form-group">
                  <div class="col-md-12">
                    ...
                    <textarea type="text" id="body" cols="30" rows="7" class="form-control" placeholder="Write your notes or questions here..."></textarea>
                  </div>
                </div>
